...
public class RegisterPage {
	...
	public boolean registerUser(String firstName, String lastName, 
		...
		eleUtil.doSendKeys(this.lastName, lastName);//eleUtil.doSendKeys(here locator of element, sendvalue-variable)
		//..>>this keyword used to invoke the class variable as class variable and parameter name are same
